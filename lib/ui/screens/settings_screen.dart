        ...
        child: Column(
          children: [
            ...
            DropdownButton<String>(
              ...
              items: ['Fácil', 'Medio', 'Dificil'].map((v) => DropdownMenuItem(value: v, child: Text(v))).toList(),
              onChanged: (v) => setState(() => _selectedDifficulty = v!),
            ),
            ElevatedButton(onPressed: _saveSettings, child: const Text("Guardar datos")),
          ],
        ),
      ),
    );
